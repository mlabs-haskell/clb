...
-- Imported from : Ledger.Tx.CardanoAPI.Internal
module ClbSocket.Serialise.Tx (
  -- |
  --
  ...
  CardanoTx (..),
  -- getEmulatorEraTx,
  getEmulatorConwayEraTx,
  getEmulatorBabbageEraTx,
  -- pattern CardanoEmulatorEraTx,
  pattern CardanoEmulatorConwayEraTx,
  pattern CardanoEmulatorBabbageEraTx,
  -- txOutRefs,
  -- unspentOutputsTx,
  fromCardanoTxId,
  fromCardanoTxIn,
...
getEmulatorConwayEraTx :: CardanoTx -> C.Tx C.ConwayEra
getEmulatorConwayEraTx (CardanoTx tx C.ShelleyBasedEraConway) = tx
getEmulatorConwayEraTx _ = error "getEmulatorEraTx: Expected a Conway tx"

getEmulatorBabbageEraTx :: CardanoTx -> C.Tx C.BabbageEra
getEmulatorBabbageEraTx (CardanoTx tx C.ShelleyBasedEraBabbage) = tx
getEmulatorBabbageEraTx _ = error "getEmulatorEraTx: Expected a Babbage tx"

pattern CardanoEmulatorConwayEraTx :: C.Tx C.ConwayEra -> CardanoTx
pattern CardanoEmulatorConwayEraTx tx <- (getEmulatorConwayEraTx -> tx)
  where
    CardanoEmulatorConwayEraTx tx = CardanoTx tx C.shelleyBasedEra

{-# COMPLETE CardanoEmulatorConwayEraTx #-}

pattern CardanoEmulatorBabbageEraTx :: C.Tx C.BabbageEra -> CardanoTx
pattern CardanoEmulatorBabbageEraTx tx <- (getEmulatorBabbageEraTx -> tx)
  where
    CardanoEmulatorBabbageEraTx tx = CardanoTx tx C.shelleyBasedEra

{-# COMPLETE CardanoEmulatorBabbageEraTx #-}
